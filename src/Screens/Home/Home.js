  ...
  render() {
    return (
      <WrapperContainer statusBarColor={colors.themeColor}>
        <View style={{backgroundColor: colors.themeColor, flexDirection: "row", justifyContent: "space-between", padding: 10}}>
          <TouchableOpacity
          ...
          <Image source={imagePath.appIconWhite}
        ...
        <View
          ...
          <View style={{alignItems: 'center', marginTop: 15}}>
            <TouchableOpacity style={{backgroundColor: colors.themeColor, paddingHorizontal: 25, paddingVertical: 10, borderRadius: 100}}>
              <Text style = {{...commonStyles.fontSize20, color: "#fff"}}>Scan QR Code</Text>
            </TouchableOpacity>
          </View>
        </View>
      </WrapperContainer>
